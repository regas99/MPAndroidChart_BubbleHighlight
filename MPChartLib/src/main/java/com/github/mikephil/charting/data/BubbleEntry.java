...
public class BubbleEntry extends Entry {
    ...
    /**
     * Returns the size of this entry (the size of the entry - not the size of the rendered circle).
     *
     * @return size
     */
    ...
    /**
     * Sets the size of this entry (the size of the entry - not the size of the rendered circle).
     * @param size
     */
